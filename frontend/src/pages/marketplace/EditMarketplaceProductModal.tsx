...
interface EditMarketplaceProductModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
  product?: Product;
...
const EditMarketplaceProductModal: React.FC<EditMarketplaceProductModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
  product,
...
export default EditMarketplaceProductModal;
